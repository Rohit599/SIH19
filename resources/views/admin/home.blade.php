          ...
          <div class="col-xl-4 col-md-4 mb-4">
            ...
            <div class="card card-cascade cascading-admin-card">
              ...
              <div class="admin-up">
                ...
                <div class="data">
                  <p>Issues</p>
                  <h4 class="ml-4 mt-4 mb-2 font-weight-bold">{{ $air_issue + $noice_issue + $soil_issue + $water_issue }}</h4>
                </div>
              </div>
              <!--/.Card Data-->
...
<script>
  ...
  var myPieChart = new Chart(ctxP, {
    type: 'pie',
    data: {
      labels: ["Air", "Noice", "Soil", "Water"],
      datasets: [{
        data: [{{ $air_issue }}, {{ $noice_issue }}, {{ $soil_issue }}, {{ $water_issue }}],
